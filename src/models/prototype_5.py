...
'''
almost the same with proto_4 but different bottleneck architecture
Basic Idea:
...
def Prototype_5(opt):
    ...
    logg("Initializing pretraining function of prototype 4 -- pr.1 with normal conv")
    ...
    bottleneck_net = utils_networks.create_bottleneck_basic2(opt)
