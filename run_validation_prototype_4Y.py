...
from src.validations.validate_prototype_4Y import Validate_prototype_4Y, Validate_prototype_4Y_0
# from  src.models.basic_ae import Basic_autoencoder
# from  src.models.basic_ae_model0 import Basic_autoencoder_model0
...
if __name__ == "__main__":
    ...
    parser.add_argument('--mask_channels', type = int, default = 0, \
...
# D:\Data\pseudoDDR_versions\Dongyang_DRR\D1\withVessel
    parser.add_argument('--baseroot', type = str, default = "D:\\Data\\pseudoDDR_versions\\Dongyang_DRR\\train\\without\\", \
        help = 'the base training folder for inpainting network')
    parser.add_argument('--baseroot_pair', type = str, default = "D:\\Data\\pseudoDDR_versions\\Dongyang_DRR\\train\\with\\", \
        help = 'the base training folder for inpainting network')
    parser.add_argument('--test_base', type = str, default = "D:\\Data\\pseudoDDR_versions\\Dongyang_DRR\\test\\without\\", \
        help = 'the base training folder for inpainting network')
    parser.add_argument('--test_base_pair', type = str, default = "D:\\Data\\pseudoDDR_versions\\Dongyang_DRR\\test\\with\\", \
        help = 'the base training folder for inpainting network')    
    ...
    if opt.model ==1 :
        Validate_prototype_4Y(opt)
    if opt.model == 0:
        Validate_prototype_4Y_0(opt)
    # if opt.model ==1 :
    #     Basic_autoencoder(opt)
    # if opt.model ==0 :
    #     Basic_autoencoder_model0(opt)