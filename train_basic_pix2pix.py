...
from src.models.base_ae_pix2pix import Basic_autoencoder_pix2pix
...
if __name__ == "__main__":
    ...
    parser.add_argument('--finetune_path', type = str, default = "", \
        help = 'load name path of models')
    parser.add_argument('--path_vgg_pretrained', type = str, default = "/brainlab_project/vessel/inpainting/pretrained_models/vgg16_pretrained.pth", \
        help = 'path to pretrained vgg network for perc loss')
...
# D:\Data\pseudoDDR_versions\Dongyang_DRR\D1\withVessel
    ...
    opt.path_vgg_pretrained = data_paths['data1'] + opt.path_vgg_pretrained
